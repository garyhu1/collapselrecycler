...
public class StickyDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickyDecoration(Context context) {
        ...
        topHeight = res.getDimensionPixelSize(R.dimen.d40);
    }
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            int position = parent.getChildAdapterPosition(view);
            String textLine = ThirdFragment.cityList.get(position).getFirstPinYin();
            if (isFirstInGroup(position)) {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        String text = ThirdFragment.cityList.get(position).getFirstPinYin();
    ...
    private boolean isFirstInGroup(int position) {
        ...
        if (position == 0) {
            ...
            if (ThirdFragment.cityList.get(position).getFirstPinYin().
                    equals(ThirdFragment.cityList.get(position - 1).getFirstPinYin())) {
                isFirst = false;
            } else {
                isFirst = true;
            }
